public class PriorityQueue<T extends Comparable<? super T>> implements QueueInterface<T>{
    ...
    private MinHeapInterface<T> queue;
    ...
    private class MinHeap<T extends Comparable<? super T>> implements MinHeapInterface<T> {
        private T[] heap; 
    ...
    private interface MinHeapInterface<T extends Comparable<? super T>> {
        public void add(T newEntry);
        public T removeMin();
        public T getMin();
        public boolean isEmpty();
